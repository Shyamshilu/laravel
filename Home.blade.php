...
<body>
  <div class="hero_area">
    ...
    <div class="hero_bg_box">
      <div class="img-box">
        <img src="images/logo.jpg" alt="background photo">
      </div>
    </div>
          ...
          <nav class="navbar navbar-expand-lg custom_nav-container">
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="Work.blade.php"> Work </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="Skills.blade.php">Skills </a>
                </li>
                <li class="nav-item">
    ...
    <section class=" slider_section ">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
       ...
       <h2>  <p>Hello! I am shilu shyam, a  developer focused on building web applications that are both functional and user-friendly. Below are some of my achievements and key points.</p>
</h2> <ul>
         <h3>   <li>Experienced in Laravel, PHP, JavaScript, and more.</li>
            <li>Successfully delivered multiple full-stack web applications.</li>
      ...
      <div class="row">
        <div class="col-md-6 px-0">
          <div class="img_container">
            <div class="img-box">
              <img src="images/about-img.jpg" alt="my image photo" />
            </div>
          </div>
        </div>
        <div class="col-md-6 px-0">
          <div class="detail-box">
            ...
            <div class="container py-5">
        <h1></h1>
        <p>Hello! I am shilu shyam, a  developer focused on building web applications that are both functional and user-friendly. Below are some of my achievements and key points.</p>
        <ul>
            <li>Experienced in Laravel, PHP, JavaScript, and more.</li>
            <li>Successfully delivered multiple full-stack web applications.</li>
            <li>Passionate about continuous learning and improvement.</li>
        </ul>
    </div>
